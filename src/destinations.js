// Koraput destinations. Distances and drive times are approximate road figures
// from Koraput town; the team confirms exact timings when planning a trip.
// Coordinates come from Wikipedia, OpenStreetMap and photo GPS data.
module.exports = [
  {
    slug: "deomali",
    name: "Deomali",
  ...
  {
    slug: "kolab",
    name: "Upper Kolab Reservoir",
    kind: "Reservoir and garden",
    icon: "wind",
