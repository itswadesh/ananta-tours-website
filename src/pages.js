...
module.exports = [
  ...
  },
  {
    ...
    hero: "deomali-hills", heroAlt: "Tar road running along the grassy ridge on top of Deomali",
    ctaPhoto: "deomali-range",
    lede: "One vehicle for the whole group, bought new in September 2026 and driven by someone who knows these roads. This page says what is confirmed, what is still to come, and how to think about seats and luggage.",
    facts: [
      { icon: "seat", label: "Passenger seats", value: "17" },
      { icon: "snowflake", label: "Cabin", value: "Air conditioned" },
      { icon: "spark", label: "Purchased", value: "September 2026" },
    ...
    blocks: [
      ...
      { type: "ul", items: ["Seventeen passenger seats plus the driver.", "Air conditioning throughout the cabin.", "New vehicle, purchased September 2026, serviced on schedule.", "An experienced local driver and a support contact on WhatsApp for the whole trip."] },
      { type: "h2", text: "What is still to come" },
      { type: "p", html: "The exact make, model and variant will be published once delivery is complete, together with photographs of the real vehicle: front, cabin, seats, legroom, AC vents, dashboard and luggage space. We will not use stock or generated pictures of a Traveller. Ask us on WhatsApp and we will tell you exactly what has been confirmed on the day you write." },
      { type: "callout", icon: "camera", html: "Real photographs of the vehicle will replace this note as soon as it arrives." },
