...
module.exports = [
  {
    ...
    metaTitle: "Tempo Traveller Rental in Koraput: 17-Seater AC",
    description: "Hire a 17-seater AC Force Traveller in Koraput with a local driver. What the quote includes, pickup points, luggage and how booking works.",
    kind: "Hire", icon: "van",
    ...
    blocks: [
      ...
      { type: "ul", items: [
        ...
        "<strong>Jeypore:</strong> town, bus stand or Jeypore Airport (IndiaOne Air from Bhubaneswar and Visakhapatnam).",
  ...
  },
  {
    ...
    short: "Group tour",
    metaTitle: "Koraput Group Tour in One 17-Seater Traveller",
    description: "How a Koraput trip works for a group of 8 to 17: one vehicle, one driver, realistic day plans, seating, meals and the questions groups ask first.",
  ...
  },
  {
    ...
    metaTitle: "Koraput 1-Day Itinerary: Temple, Kolab, Deomali Sunset",
  ...
  },
  {
    ...
    metaTitle: "Koraput 4-Day Itinerary: Adds Gupteswar and Maliguda",
    description: "A four-day Koraput itinerary in all three directions: town and Kolab, Deomali, Duduma Waterfall, then Gupteswar and the Maliguda railway.",
    kind: "Itinerary", icon: "calendar",
  ...
  },
  {
    ...
    short: "Contact",
    metaTitle: "Contact Ananta Tours, Semiliguda, Koraput",
    description: `Reach Ananta Tours & Travels in Semiliguda, Koraput. WhatsApp ${c.whatsappDisplay} or call ${c.phones[0].display} for trip planning and 17-seater Traveller bookings.`,
    ...
    blocks: [
      ...
      { type: "ul", items: ["Travel dates, or the month if dates are open.", "Number of travellers and rough luggage.", "Where you arrive: your train number and station, your IndiaOne Air flight to Jeypore, or your bus (see the <a href=\"../#stations\">pickup section</a> for timings).", "Places you want to include, or just say how many days you have."] },
